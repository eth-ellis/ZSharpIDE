...
namespace ZSharpIDE.Extensions
{
    public class RichEditBoxExtension
    {
        ...
        public static readonly DependencyProperty PlainTextProperty = DependencyProperty.RegisterAttached("PlainText", typeof(string), typeof(RichEditBoxExtension), new PropertyMetadata(null, OnPlainTextChanged));
